...
export function Badge({ label, tone = "neutral" }: { label: string; tone?: "neutral" | "success" | "warning" | "danger" | "pedro" | "camilly" | "couple" }) {
...
const styles = StyleSheet.create({
  ...
  couple: { backgroundColor: theme.colors.couple, color: theme.colors.coupleStrong }
});
